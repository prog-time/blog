...
description: "Автоматизация разработки на Laravel: Docker Compose, git-хуки, статический анализ PHPStan, линтинг Pint и автоматические проверки кода."
keywords: "Laravel, git hooks, PHPStan, Pint, Docker Compose, автоматизация, линтинг, PHP"
---
