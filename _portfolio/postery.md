...
- **README (Hero)** — описание проекта, скриншоты и быстрый старт.
- **Возможности** — поддерживаемые платформы и типы контента.
- **Установка** — шаги развёртывания через Docker.
- **Конфигурация** — переменные окружения и примеры настроек каналов.
- **Примеры использования** — сценарии публикации, CLI и API.
